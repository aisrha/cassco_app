...
class Formative1Screen extends StatefulWidget {
  const Formative1Screen({Key? key}) : super(key: key);

  @override
  State<Formative1Screen> createState() => _Formative1ScreenState();
}

class _Formative1ScreenState extends State<Formative1Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Formative Assessment : Topic 1'),
