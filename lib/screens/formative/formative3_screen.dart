...
class Formative3Screen extends StatefulWidget {
  const Formative3Screen({Key? key}) : super(key: key);

  @override
  State<Formative3Screen> createState() => _Formative3ScreenState();
}
...
class _Formative3ScreenState extends State<Formative3Screen> {
  ...
  void initState() {
    super.initState();
    _quiz1 = FirebaseFirestore.instance.collection('topic3').snapshots();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Formative Assessment : Topic 3'),
